...
public class CareerDTO {
    ...
    public CareerDTO(Integer jobId, String jobName, LocalDate startWorkDate, LocalDate endWorkDate, LocalDate startRecruitDate, LocalDate endRecruitDate, Integer pay, String country, String city, String cropForm, String cropType) {
        this.jobId = jobId;
