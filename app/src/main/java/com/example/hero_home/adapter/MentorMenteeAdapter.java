...
import com.example.hero_home.activity.ActivityMenteeDetailPage;
import com.example.hero_home.activity.ActivityMentorDetailPage;
import com.example.hero_home.model.MatchingListInfoDTO;
import com.example.hero_home.model.MentorMenteeDTO;
            ...
            matchingItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(txtStatus.getText().toString().equals("mentor")) {
                        Intent intent = new Intent(itemView.getContext(), ActivityMentorDetailPage.class);
                        intent.putExtra("matchingId", matchingId.getText().toString());
                        itemView.getContext().startActivity(intent);
                    } else {
                        Intent intent = new Intent(itemView.getContext(), ActivityMenteeDetailPage.class);
                        intent.putExtra("matchingId", matchingId.getText().toString());
                        itemView.getContext().startActivity(intent);
                    }
                }
