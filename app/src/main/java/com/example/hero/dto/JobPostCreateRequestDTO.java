...
public class JobPostCreateRequestDTO {
    ...
    private String userType; //공고 작성자 유형
    ...
    private Uri uploadImgFile; //이미지 파일
    ...
    public JobPostCreateRequestDTO(String userId, String userType, String jobName, String country, String city,
                                   ...
                                   String spec, String jobIntro, String workAddress, Uri uploadImgFile) {
        this.userId = userId;
    ...
    public JobPostCreateRequestDTO() {
        // 기본 생성자
    }
    ...
    public Uri getUploadImgFile() {
        return uploadImgFile;
    }

    public void setUploadImgFile(Uri uploadImgFile) {
        this.uploadImgFile = uploadImgFile;
    }
}
